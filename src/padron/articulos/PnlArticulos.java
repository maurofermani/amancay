...
public class PnlArticulos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnlTalles = new padron.articulos.PnlPrecios();
        ...
        pnlArticulo.setLayout(new java.awt.BorderLayout());

        tbrBotones.setFloatable(false);
        tbrBotones.setRollover(true);
        tbrBotones.setPreferredSize(new java.awt.Dimension(244, 65));
        ...
        btnBaja.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/gnome/32x32/actions/edit-delete.png"))); // NOI18N
        ...
        pnlArticulo.add(tbrBotones, java.awt.BorderLayout.PAGE_START);
        ...
        pnlDatosLayout.setHorizontalGroup(
            ...
            .addGroup(pnlDatosLayout.createSequentialGroup()
                ...
                .addGroup(pnlDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlTalles, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(pnlDatosLayout.createSequentialGroup()
        ...
        pnlDatosLayout.setVerticalGroup(
            ...
            .addGroup(pnlDatosLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(pnlTalles, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                .addContainerGap())
        );

        pnlArticulo.add(pnlDatos, java.awt.BorderLayout.CENTER);

        split.setRightComponent(pnlArticulo);
    ...
    private padron.articulos.PnlPrecios pnlTalles;
    ...
    private void _setModo(short modo) {
        ...
        switch (modo) {
            ...
            case MODO_EDICION:
                ...
                btnEditar.setEnabled(true);
                btnNuevo.setEnabled(false);
                btnEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/gnome/32x32/actions/document-save.png")));
    ...
    private void _setRegistro(ArticuloReg articululoReg) {
        ...
        if (articululoReg == null || articululoReg.getId() == 0) {
            ...
            pnlTalles.setArticulo(articululoReg);
        }
    }
